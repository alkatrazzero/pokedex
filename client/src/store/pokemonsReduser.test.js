import pokemonsReduser, {
  addNewFavoritePokemon,
  currentPageSize, removeOndFavoritePokemon,
  setCurrentPage,
  setTotalPokemonsCount
} from './pokemonsReduser'


it('favorite pokemon should be deleted',()=>{
  // let action = removeOndFavoritePokemon({
  //   "abilities": [
  //     {
  //       "ability": {
  //         "name": "limber",
  ...
  let newState=pokemonsReduser(initialState,action)
 expect (newState.favoritePokemons.length).toBe(0)

})

it('favorite pokemon should be added',()=>{
  // let action = addNewFavoritePokemon({
  //   "abilities": [
  //     {
  //       "ability": {
  //         "name": "static",
  ...
  let newState=pokemonsReduser(initialState,action)
  expect (newState.favoritePokemons.length).toBe(2)
